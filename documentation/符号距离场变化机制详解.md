...
符号距离场（Signed Distance Field，SDF）是NexDynFEM中用于碰撞检测和接触处理的核心数据结构。本文档详细说明SDF在计算过程中是如何产生变化的，包括初始化、计算、更新和与可变形对象的交互机制。
...
在NexDynFEM中，SDF通常是**静态**的，在初始化时计算一次，然后在整个模拟过程中保持不变：
...
**文档版本**：1.0  
**最后更新**：2026-01-11  
**参考代码**：NexDynFEM libraries/distanceField
